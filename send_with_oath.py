"""
Send an email via gmail using oath2 correctly, rather than the traditional allow less secure apps
The less secure apps option is going away anyway

most of this came from this tutorial:
...
GOOGLE_CLIENT_SECRET = creds["installed"]["client_secret"]
GOOGLE_REFRESH_TOKEN = creds["installed"]["grt"]
...
def url_escape(text):
    #for making text url safe
    return urllib.parse.quote(text, safe='~-._')


def url_unescape(text):
    #for making text readable
    return urllib.parse.unquote(text)


def url_format_params(params):
    #assembling the paramaters for the get request
    param_fragments = []
...
def generate_permission_url(client_id, scope='https://mail.google.com/'):
    #put together the get request format
    params = {}
...
def generate_oauth2_string(username, access_token, as_base64=False):
    #assemble the string for the oath request
...
if __name__ == '__main__':
    ...
    send_mail('jmmarkman@gmail.com', 'jmmarkman@gmail.com',
